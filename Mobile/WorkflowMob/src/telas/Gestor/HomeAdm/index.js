...
//Mostra a foto do Usuario:
  useEffect(() => {
    if (!usuario.AdminId || !usuario.role) return;

    async function carregarImagens() {
      try {
        const response = await fetch(`${url}/dev4tech/imagem_usuario.php`,{
            method:'POST',
            headers:{'Content-Type': 'application/json'},
            body: JSON.stringify({id: usuario.AdminId, role: usuario.role})
          }
        );
                ...
                <View style={styles.areacard}>
                    ...
                    <Card style={styles.cardtarequi}>
                        <Card.Cover 
                            ...
                            style={styles.imagemcard}/>
                        <Card.Content style={styles.cardinferior}>
                            <Title style={styles.titulocard}>Cadastrar Equipe</Title>
                        </Card.Content>
                    </Card>
                    </TouchableOpacity>
                    ...
                    <Card style={styles.cardtarequi}>
                        <Card.Cover 
                            ...
                            style={styles.imagemcard}/>
                        <Card.Content style={styles.cardinferior}>
                            <Title style={styles.titulocard}>Cadastrar Tarefa</Title>
                        </Card.Content>
                    </Card>
                    </TouchableOpacity>
