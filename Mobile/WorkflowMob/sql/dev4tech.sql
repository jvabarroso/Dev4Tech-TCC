...
INSERT INTO Administradores (Nome, Cargo, CPF, DataNascimento, Telefone, Email, Senha, data_cadAdmin)
VALUES 
('Carlos Silva', 'Gerente de TI', '12345678901', '1980-04-15', '11987654321', 'carlos.silva@empresa.com', 'senha123hash', NOW()),
('Marina Souza', 'Diretora', '10987654321', '1975-09-30', '11912345678', 'marina.souza@empresa.com', 'senha456hash', NOW());

-- Inserts para Funcionarios
INSERT INTO Funcionarios (Nome, Cargo, CPF, DataNascimento, Telefone, Email, Senha, data_cadFunc, endereço, numero)
VALUES 
('Ana Pereira', 'Analista de Sistemas', '23456789012', '1990-02-20', '11987651234', 'ana.pereira@empresa.com', 'senha789hash', NOW(), 'Rua das Flores', '123'),
